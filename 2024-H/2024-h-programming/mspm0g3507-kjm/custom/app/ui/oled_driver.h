...
#define OLED_I2C_SCL_PORT   GPIO_SPI_0_PICO_PORT
#define OLED_I2C_SCL_PIN    GPIO_SPI_0_PICO_PIN

#define OLED_I2C_SDA_PORT   GPIO_SPI_0_SCLK_PORT
#define OLED_I2C_SDA_PIN    GPIO_SPI_0_SCLK_PIN

#define OLED_I2C_SDA_IOMUX 	GPIO_SPI_0_IOMUX_SCLK
#define OLED_I2C_SCL_IOMUX  GPIO_SPI_0_IOMUX_PICO
