...
static const struct
{
    ...
    // 单个传感器
    {0x01, -3.5f}, // 0b00000001 (bit 0)
    {0x02, -2.5f}, // 0b00000010 (bit 1)
    {0x04, -1.5f}, // 0b00000100 (bit 2)
    {0x08, -0.5f}, // 0b00001000 (bit 3)
    {0x10, 0.5f},  // 0b00010000 (bit 4)
    {0x20, 1.5f},  // 0b00100000 (bit 5)
    {0x40, 2.5f},  // 0b01000000 (bit 6)
    {0x80, 3.5f},  // 0b10000000 (bit 7)
    // 两个传感器
    {0x03, -3.0f}, // 0b00000011 (bit 0,1)
    {0x06, -2.0f}, // 0b00000110 (bit 1,2)
    {0x0C, -1.0f}, // 0b00001100 (bit 2,3)
    {0x18, 0.0f},  // 0b00011000 (bit 3,4) ⭐ 中心
    {0x30, 1.0f},  // 0b00110000 (bit 4,5)
    {0x60, 2.0f},  // 0b01100000 (bit 5,6)
    {0xC0, 3.0f},  // 0b11000000 (bit 6,7)
    // 三个传感器
    {0x07, -2.5f}, // 0b00000111 (bit 0,1,2)
    {0x0E, -1.5f}, // 0b00001110 (bit 1,2,3)
    {0x1C, -0.5f}, // 0b00011100 (bit 2,3,4)
    {0x38, 0.5f},  // 0b00111000 (bit 3,4,5)
    {0x70, 1.5f},  // 0b01110000 (bit 4,5,6)
    {0xE0, 2.5f},  // 0b11100000 (bit 5,6,7)
